    ...
    class MobiContainer
    {
            ...
            while (true)
            {
                ...
                switch (type)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        throw new NotImplementedException($"未知块类型{type}");
                }
            }
        }
        ...
        static IEnumerable<Frame> DemuxMoflex(Stream stream)
        {
            ...
            using (var br = new BitReader(stream, true))
                while (br.BaseStream.Position < br.BaseStream.Length)
                {
                    ...
                    if ((flags & 2) != 0) throw new NotImplementedException("未知的标志掩码");
        ...
        public static IEnumerable<Frame> Demux(string path)
        {
            ...
            switch (b)
            {
                ...
                default: throw new NotSupportedException("未知文件类型");
            }
        }
        ...
        public static List<Frame> GetHeaders(string path)
        {
            using (var stream = File.OpenRead(path))
            {
                ...
                {
                    throw new NotSupportedException("未知文件类型");
                }
            }
        }
    }
